...
image::github-ghpages-in-private-repos.png[background, size="cover"]
...
https://htl-leonding-college.github.io/git-lecture-notes/#_a_first_commit[A first Commit, window="_blank"]
...
* https://codewithmosh.com/[Code with Mosh (Aktionen abwarten), window="_blank"]
* https://www.udemy.com/[Udemy (Aktionen abwarten), window="_blank"]
